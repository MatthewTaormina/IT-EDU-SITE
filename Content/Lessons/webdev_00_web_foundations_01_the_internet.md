...
type: lesson
title: "The Internet"
description: "The Internet is the global network that lets a browser on your laptop talk to a server on the other side of the world. This lesson covers what web developers need to know about it — no networking d..."
duration_minutes: 15
tags:
  - internet
  - client-server
...
As a web developer, you rarely type IP addresses manually. **DNS** (covered in [lesson 07](./webdev_00_web_foundations_07_dns.md)) translates human-readable domain names like `google.com` into the IP address the network uses to route your request.
