...
Navigation links — covered in [Lesson 04](./04_links_and_navigation.md). Pages can have multiple `<nav>` elements (main navigation + footer navigation + table of contents).
