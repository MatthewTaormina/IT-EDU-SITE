...
| Challenge | Hint |
| :-- | :-- |
| Showing/hiding the mobile nav | Add/remove a CSS class with `classList.toggle()` — review [DOM Manipulation](../03_JS_Basics/05_the_dom/02_dom_manipulation.md) |
...
| Clearing errors on input | Use `addEventListener("input", ...)` on each field — review [Events](../03_JS_Basics/05_the_dom/03_events.md) |
| Preventing page reload | `event.preventDefault()` in the `submit` listener — review [Events](../03_JS_Basics/05_the_dom/03_events.md) |
