...
> Linked to: [[.objectives/vision.md]] | [[.tasks/tasks.md]] | [[.objectives/milestones.md]]
> Source research: [[.knowledge/programming/core-competencies-fullstack.md]] | [[.knowledge/web-dev/frontend-stack.md]] | [[.knowledge/web-dev/backend-stack.md]] | [[.knowledge/web-dev/infrastructure.md]]
...
| **Estimated Hours** | ~40 |
| **Kanban** | TASK-018 |
| **Missing Research** | [[.knowledge/programming/git-workflow.md]] (TASK-016 — to create) |
...
| **Estimated Hours** | ~60 |
| **Kanban** | TASK-019 |
| **Missing Research** | [[.knowledge/programming/automated-testing.md]] (TASK-011 — CRITICAL, to create) |
...
| **Estimated Hours** | ~50 |
| **Kanban** | TASK-020 |
| **Missing Research** | None — [[.knowledge/web-dev/backend-stack.md]] and [[.knowledge/web-dev/infrastructure.md]] cover this tier |
...
| **Estimated Hours** | ~50 |
| **Kanban** | TASK-021 |
| **Missing Research** | [[.knowledge/web-dev/web-security.md]] (TASK-012 — to create); `.knowledge/web-dev/backend-stack.md` WebSockets expansion (TASK-013) |
...
| **Estimated Hours** | ~45 |
| **Kanban** | TASK-022 |
| **Missing Research** | None — [[.knowledge/web-dev/infrastructure.md]] covers Docker, deployment, and DNS at the required level |
...
| **Estimated Hours** | ~60 |
| **Kanban** | TASK-023 |
| **Missing Research** | [[.knowledge/web-dev/nextjs-fullstack.md]] (TASK-014 — to create); [[.knowledge/web-dev/observability.md]] (TASK-015 — to create) |

---

## Missing Research Summary

The following research documents must be created before the corresponding course nodes can be fully authored. These are tracked in [[.tasks/tasks.md]].

| Task | File to Create/Expand | Required By | Severity |
| :--- | :--- | :--- | :--- |
| TASK-011 | `.knowledge/programming/automated-testing.md` | FrontEndAdvanced (Node 3), BackendAdvanced (Node 5), FullStackAdvanced (Node 7) | 🔴 CRITICAL |
| TASK-012 | `.knowledge/web-dev/web-security.md` | BackendAdvanced (Node 5) | 🟠 HIGH |
| TASK-013 | Expand `.knowledge/web-dev/backend-stack.md` (WebSockets & SSE) | BackendAdvanced (Node 5) | 🟡 MEDIUM |
| TASK-014 | `.knowledge/web-dev/nextjs-fullstack.md` | FullStackAdvanced (Node 7) | 🟠 HIGH |
| TASK-015 | `.knowledge/web-dev/observability.md` | FullStackAdvanced (Node 7) | 🟠 HIGH |
| TASK-016 | `.knowledge/programming/git-workflow.md` | FrontEndIntermediate (Node 2) | 🟠 HIGH |
...
*Last updated: 2026-04-14 | Owner: Lead Curriculum Architect | Source: [[.objectives/vision.md]], [[.knowledge/programming/core-competencies-fullstack.md]]*
