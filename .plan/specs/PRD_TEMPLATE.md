...
> Copy this file and rename it `PRD_<FEATURE_SLUG>.md`. Fill in every section before writing a single line of code. Link the completed PRD to its Kanban task in [[.plan/operations/tasks.md]].
...
> Render wireframes in Mermaid.js or SVG only. Link to the UX file in [[.plan/ux/]].
...
*Full wireframes: [[.plan/ux/<feature_slug>_wireframe.md]]*
...
*Template version: 1.0 | Source of truth: [[.plan/specs/PRD_TEMPLATE.md]]*
