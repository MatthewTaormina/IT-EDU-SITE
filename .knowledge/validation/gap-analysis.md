...
**Comparison baseline:** The 14 research nodes currently in `.knowledge/` as of 2026-04-14.
...
| **Recommended Action** | Create `.knowledge/programming/llm-api-integration.md` covering: prompt engineering, streaming, tool use, embeddings, token budgeting, and error handling for API failures |
...
| **Recommended Action** | Create `.knowledge/programming/agent-orchestration.md` covering: agent loop patterns, tool definition schemas, multi-agent coordination, error recovery, observability for agents |
...
| **Recommended Action** | Create `.knowledge/programming/mcp-model-context-protocol.md` covering: MCP architecture, server authoring, resource exposure, tool schema design, and integration with agent frameworks |
...
| **Recommended Action** | Create `.knowledge/programming/automated-testing.md` covering: testing pyramid, unit vs integration vs e2e tradeoffs, test doubles, TDD red-green-refactor, coverage as a signal vs a target |
...
| **Recommended Action** | Expand `frontend-stack.md` TypeScript section with advanced patterns; OR create separate `.knowledge/programming/typescript-advanced.md` |
...
| **Recommended Action** | Create `.knowledge/web-dev/observability.md` covering: three pillars of observability (logs, metrics, traces), OpenTelemetry instrumentation, structured logging patterns, alerting design |
...
| **Recommended Action** | Create `.knowledge/programming/vector-databases-embeddings.md`; link to `backend-stack.md` (PostgreSQL + pgvector) and `llm-api-integration` |
...
| **Recommended Action** | Expand `web-standards.md` WebAssembly section significantly; or create `.knowledge/programming/webassembly.md` |
...
| **Recommended Action** | Create `.knowledge/web-dev/web-security.md` covering OWASP Top 10 (2021), dependency auditing, secret scanning, CSP, security headers |
